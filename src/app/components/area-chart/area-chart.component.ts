...
export class AreaChartComponent implements OnInit, OnChanges {
  ...
  data!: number[];
    ...
    private createAreaCharts() {
        this.paths = [];
        this.bins.forEach((row: any, index: string) => {
    ...
    private updateAreaCharts() {
        this.paths.forEach((path: { datum: (arg0: any) => { (): any; new(): any; transition: { (): { (): any; new(): any; duration: { (arg0: number): { (): any; new(): any; attr: { (arg0: string, arg1: d3.Area<[number, number]>): void; new(): any; }; }; new(): any; }; }; new(): any; }; }; }, index: string | number) => {
